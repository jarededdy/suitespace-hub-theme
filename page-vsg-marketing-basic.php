...
<?php
// Check rows exists.
if( have_rows('hub_modules') ):

    // Loop through rows.
    while( have_rows('hub_modules') ) : the_row(); 

        $sub_value = get_sub_field('sub_field');
        $module_title = get_sub_field('module_title');
        $module_icon = get_sub_field('module_icon');
        $module_button_text = get_sub_field('module_button_text');
        $module_button_link = get_sub_field('module_button_link');
        ?>
